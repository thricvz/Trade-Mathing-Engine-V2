...
TEST(Sell_fill_or_kill_tests, insufficient_number_of_buy_orders ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 999u, OrderSide::SELL, OrderType::LIMIT, Price{5, 0}, 10'000u , true}
  ));
...
TEST(Sell_fill_or_kill_tests, empty_fill_or_kill_order ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 0u, OrderSide::SELL, OrderType::LIMIT, Price{1, 0}, 10'000u , true}
  ));
...
TEST(Sell_fill_or_kill_tests, insufficient_number_of_buy_orders_within_price_criteria ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 999u, OrderSide::SELL, OrderType::LIMIT, Price{3, 75}, 10'000u , true}
  ));

  OrderBook orderbook(&factory); 

  Price pricelevel1_price{100, 0};
  Price pricelevel2_price{10, 34};
  Price inaccessible_price{3, 3};
 
  TestExtensions::OrderBook::loadOrders(&factory, &orderbook, 
    std::vector{
      OrderData{9u,  101u , OrderSide::BUY, OrderType::LIMIT, pricelevel1_price, 50u },
      OrderData{10u, 104u , OrderSide::BUY, OrderType::LIMIT, pricelevel1_price, 1007u },
      OrderData{11u, 102u , OrderSide::BUY, OrderType::LIMIT, pricelevel2_price, 2008u },
      OrderData{11u, 103u , OrderSide::BUY, OrderType::LIMIT, pricelevel1_price, 30u },
      OrderData{11u, 107u , OrderSide::BUY, OrderType::LIMIT, pricelevel1_price, 33u },
      OrderData{8u,  109u , OrderSide::BUY, OrderType::LIMIT, inaccessible_price, 100'000'000u },
      OrderData{7u,  110u , OrderSide::BUY, OrderType::LIMIT, inaccessible_price, 500'000u },
    }    
  );
...
TEST(Sell_fill_or_kill_tests, sufficient_number_of_buy_orders_within_criteria ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 999u, OrderSide::SELL, OrderType::LIMIT, Price{3, 25}, 3008u , true}
  ));

  OrderBook orderbook(&factory); 

  Price pricelevel1_price{200,0};
  Price pricelevel2_price{10, 34};
  Price pricelevel3_price{3, 3};
...
TEST(Buy_fill_or_kill_tests, insufficient_number_of_sell_orders ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 999u, OrderSide::BUY, OrderType::LIMIT, Price{50, 0}, 10'000u , true}
  ));
...
TEST(Buy_fill_or_kill_tests, empty_fill_or_kill_order ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 0u, OrderSide::BUY, OrderType::LIMIT, Price{330, 0}, 10'000u , true}
  ));
...
TEST(Buy_fill_or_kill_tests, insufficient_number_of_sell_orders_within_criteria ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 999u, OrderSide::BUY, OrderType::LIMIT, Price{300, 75}, 10'000u , true}
  ));
  ...
  Price pricelevel1_price{100, 0};
  Price pricelevel2_price{10, 34};
  Price inaccessible_price{301, 3};
 
  TestExtensions::OrderBook::loadOrders(&factory, &orderbook, 
    std::vector{
      OrderData{9u,  101u , OrderSide::SELL, OrderType::LIMIT, pricelevel1_price, 50u },
      OrderData{10u, 104u , OrderSide::SELL, OrderType::LIMIT, pricelevel1_price, 1007u },
      OrderData{11u, 102u , OrderSide::SELL, OrderType::LIMIT, pricelevel2_price, 2008u },
      OrderData{11u, 103u , OrderSide::SELL, OrderType::LIMIT, pricelevel1_price, 30u },
      OrderData{11u, 107u , OrderSide::SELL, OrderType::LIMIT, pricelevel1_price, 33u },
      OrderData{8u,  109u , OrderSide::SELL, OrderType::LIMIT, inaccessible_price, 100'000'000u },
      OrderData{7u,  110u , OrderSide::SELL, OrderType::LIMIT, inaccessible_price, 500'000u },
    }    
  );
...
TEST(Buy_fill_or_kill_tests, insufficient_number_of_sell_orders_from_different_owner ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 999u, OrderSide::BUY, OrderType::LIMIT, Price{1000, 75}, 10'000u , true}
  ));
...
TEST(Buy_fill_or_kill_tests, sufficient_number_of_sell_orders_within_criteria ) {
  auto incomingOrder = std::move(factory.createOrder(
      OrderData{1u, 999u, OrderSide::BUY, OrderType::LIMIT, Price{40, 0}, 3008u , true}
  ));
